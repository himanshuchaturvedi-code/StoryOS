 ...
 */
export function asOf(date: Date = new Date()): TemporalFilter {
  return {
    effectiveFrom: { lte: date },
    OR: [{ effectiveTo: null }, { effectiveTo: { gt: date } }],
  };
 ...
 */
export function currentlyEffective(): TemporalFilter {
 ...
 */
export function activeDuring(rangeStart: Date, rangeEnd: Date): DateRangeFilter {
  return {
 ...
 */
export function activeOn(date: Date): DateRangeFilter {
